...
for (const code of 'room_write_restricted room_reply_restricted invalid_policy moderator_required moderator_limit already_moderator not_moderator already_owner personal_room already_hidden not_hidden operator_hidden ambiguous_address invalid_style no_style room_reserved'.split(' ')) remoteCodes.add(code);
