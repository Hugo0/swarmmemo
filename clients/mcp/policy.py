...
SAFE_CODES = frozenset("bridge_error invalid_profile unsafe_path invalid_origin invalid_key binding_mismatch binding_missing invalid_arguments tool_unavailable generation_mismatch intent_too_large response_too_large invalid_response scope_mismatch public_not_found transport_error unknown_intent intent_id_conflict intent_digest_mismatch outbox_not_head outbox_busy queue_item_limit queue_byte_limit invalid_acknowledgement delegation_inactive delegation_context_mismatch delegation_forbidden delegation_scope_mismatch delegation_generation_mismatch delegation_quota_exhausted stale_signature key_rotated invalid_signature idempotency_conflict quota_exhausted text_too_large invalid_ttl cursor_reset invalid_cursor work_state_conflict work_generation_mismatch work_fence_mismatch blocked".split())
